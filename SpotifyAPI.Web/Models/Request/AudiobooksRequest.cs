...
{
  public class AudiobooksRequest : RequestParams
  {
    /// <summary>
    /// AudiobooksRequest
    /// </summary>
    /// <param name="ids">A comma-separated list of the Spotify IDs for the audiobooks. Maximum: 50 IDs.</param>
    public AudiobooksRequest(IList<string> ids)
    {
