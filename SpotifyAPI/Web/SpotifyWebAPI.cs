...
namespace SpotifyAPI.Web
{
    ...
    public sealed class SpotifyWebAPI : IDisposable
    {
        ...
        public async Task<ErrorResponse> Follow(FollowType followType, List<string> ids)
        {
            ...
            return (await UploadData<ErrorResponse>(_builder.Follow(followType),
        ...
        public async Task<ErrorResponse> Unfollow(FollowType followType, List<string> ids)
        {
            ...
            return (await UploadData<ErrorResponse>(_builder.Unfollow(followType), ob.ToString(Formatting.None), "DELETE").ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        public async Task<ErrorResponse> SaveTracks(List<string> ids)
        {
            ...
            return (await UploadData<ErrorResponse>(_builder.SaveTracks(), array.ToString(Formatting.None), "PUT").ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        {
            JArray array = new JArray(ids);
            return (await UploadData<ErrorResponse>(_builder.RemoveSavedTracks(), array.ToString(Formatting.None), "DELETE").ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        {
            JArray array = new JArray(ids);
            return (await UploadData<ErrorResponse>(_builder.SaveAlbums(), array.ToString(Formatting.None), "PUT").ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        {
            JArray array = new JArray(ids);
            return await UploadData<ErrorResponse>(_builder.RemoveSavedAlbums(), array.ToString(Formatting.None), "DELETE").ConfigureAwait(false) ?? new ErrorResponse();
        }
        ...
        public async Task<ErrorResponse> UpdatePlaylist(string userId, string playlistId, string newName = null, bool? newPublic = null)
        {
            ...
            return (await UploadData<ErrorResponse>(_builder.UpdatePlaylist(userId, playlistId), body.ToString(Formatting.None), "PUT").ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        public async Task<ErrorResponse> ReplacePlaylistTracks(string userId, string playlistId, List<string> uris)
        {
            ...
            return await UploadData<ErrorResponse>(_builder.ReplacePlaylistTracks(userId, playlistId), body.ToString(Formatting.None), "PUT").ConfigureAwait(false) ?? new ErrorResponse();
        }
        ...
        public async Task<ErrorResponse> RemovePlaylistTracks(string userId, string playlistId, List<DeleteTrackUri> uris)
        {
            ...
            return await (UploadData<ErrorResponse>(_builder.RemovePlaylistTracks(userId, playlistId, uris), body.ToString(Formatting.None), "DELETE").ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        public async Task<ErrorResponse> AddPlaylistTracks(string userId, string playlistId, List<string> uris, int? position = null)
        {
            ...
            return await (UploadData<ErrorResponse>(_builder.AddPlaylistTracks(userId, playlistId, uris, position), body.ToString(Formatting.None)).ConfigureAwait(false)) ?? new ErrorResponse();
        }
        ...
        private async Task<ListResponse<T>> DownloadList<T>(string url)
        {
            ...
            do
            {
                ...
                Tuple<ResponseInfo, JToken> res = await DownloadDataAlt<JToken>(url).ConfigureAwait(false);
        ...
        public async Task<T> UploadData<T>(string url, string uploadData, string method = "POST") where T : BasicModel
        {
            ...
            do
            {
                ...
                headers[0] = new KeyValuePair<string, string>("Authorization", TokenType + " " + AccessToken);
                ...
                response = await WebClient.UploadJson<T>(url, uploadData, method).ConfigureAwait(false);
        ...
        public async Task<T> DownloadData<T>(string url) where T : BasicModel
        {
            ...
            {
                if (response != null) { await Task.Delay(RetryAfter).ConfigureAwait(false); }
                response = await DownloadDataAlt<T>(url).ConfigureAwait(false);
        ...
        {
            if (UseAuth)
                return WebClient.DownloadJson<T>(url, new KeyValuePair<string, string>("Authorization", TokenType + " " + AccessToken));
